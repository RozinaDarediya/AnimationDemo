package com.theta.animationdemo.sparkleMotion;
...
public class SparkleDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sparkle_demo);

        sparkleViewPagerLayout = findViewById(R.id.view_pager_layout);
    ...
    private static class PagerAdapter extends ViewPagerAdapter {
        ...
        private View buildThirdPage(ViewGroup container) {
            return LayoutInflater.from(container.getContext()).inflate(R.layout.sparkel_page_3, container, false);
        }
