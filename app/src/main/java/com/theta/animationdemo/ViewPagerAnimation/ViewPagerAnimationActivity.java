package com.theta.animationdemo.ViewPagerAnimation;
...
//        viewPager.setAdapter(new ViewPagerAdapter(R.array.icons, R.array.titles, R.array.hints));
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        String[] title = ViewPagerAnimationActivity.this.getResources().getStringArray(R.array.titles);
